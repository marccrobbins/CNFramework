...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_framework p_framework;
        ...
        public static SteamVR_Input_ActionSet_framework framework
        {
            get
            {
                return SteamVR_Actions.p_framework.GetCopy<SteamVR_Input_ActionSet_framework>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_framework = ((SteamVR_Input_ActionSet_framework)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_framework>("/actions/framework")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.framework};
        }
    }
}
